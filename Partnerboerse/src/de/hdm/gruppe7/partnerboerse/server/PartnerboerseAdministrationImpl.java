...
/**
 * <p>
 * Implementierungsklasse des Interface <code>PartnerboerseAdministration</code>. Diese
 ...
 * <code>PartnerboerseAdministration</code> bilden nur die Server-seitige Sicht der
 ...
 * Basis für die Anbindung von <code>PartnerboerseAdministrationImpl</code> 
 * an die Runtime des GWT RPC-Mechanismus.</li>
 * </ol>
 * </p>
 * <p>
 ...
 * Idee, in diesen Mappern auch Applikationslogik zu realisieren. 
 * Einzig nachvollziehbares Argument für einen solchen Ansatz ist die 
 * Steigerung der Performance umfangreicher Datenbankoperationen. 
 * Doch auch dieses Argument zieht nur dann,
 ...
 * </p>
 * <p>
 * Sämtliche Methoden, die mittels GWT RPC aufgerufen werden,
...
implements PartnerboerseAdministration {
	...
	/**
	   * Referenz auf den DatenbankMapper, der Nutzerprofil-Objekte mit der Datenbank
	   * abgleicht.
	   */
	...
	public void init() throws IllegalArgumentException {
	    /*
	     * Ganz wesentlich ist, dass die PartnerboerseAdministration 
	     * einen vollständigen Satz von Mappern besitzt, 
	     * mit deren Hilfe sie dann mit der Datenbank
	     * kommunizieren kann.
	     */
	  ...
	  /**
	   * Anlegen eines neuen Nutzerprofils. Dies führt implizit zu einem 
	   * Speichern des neuen Nutzerprofils in der Datenbank.
	   * 
	   * Änderungen an Nutzerprofil-Objekten müssen stets durch Aufruf
	   * von {@link #save(Nutzerprofil nutzerprofil)} in die Datenbank 
	   * transferiert werden.
	   * 
