		...
		try {
			...
			ResultSet rs = stmt.executeQuery(
					"SELECT t_nutzerprofil1.nutzerprofil_id, t_nutzerprofil1.vorname, t_nutzerprofil1.nachname, "
							...
							+ "AND (t_besuch1.nutzerprofil_id != " + profilId + " OR t_besuch1.fremdprofil_id IS NULL) "
							+ "AND (t_sperrung1.fremdprofil_id != " + profilId + " OR t_sperrung1.nutzerprofil_id IS NULL) "
							+ "AND t_aehnlichkeitnp1.nutzerprofil_id = " + profilId + " ORDER BY t_aehnlichkeitnp1.aehnlichkeit DESC");
