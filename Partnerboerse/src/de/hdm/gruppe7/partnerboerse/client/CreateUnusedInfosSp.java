...
public class CreateUnusedInfosSp extends VerticalPanel {
	 ...
	 */
	public CreateUnusedInfosSp(int suchprofilId) {	
		...
		ClientsideSettings.getPartnerboerseAdministration().getAllUnusedEigenschaftenNeuSp(suchprofilIdInt,
...
//											ClientsideSettings.getPartnerboerseAdministration().createInfoNeuSp(suchprofilIdInt,
...
//																
//																informationLabelB.setText(String.valueOf(suchprofilIdInt));
//																
