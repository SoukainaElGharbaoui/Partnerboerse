...
//	private int fremdprofilId;
	 ...
	 * 
	 * @param listtyp
	 *            Der Listtyp der Seite, von der das Anzeigen des Fremprofils
	 *            aufgerufen wird (Merkliste).
	 */
	...
	public void run() {
		...
		/**
		 * ClickHandler fuer den Button zum Auswaehlen aller angezeigten Profile
		...
		loeschenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				 ...
				 * Nutzerprofil wird dann aus der Merkliste entfernt.
				 */
	 ...
	 * Das Ergebnis der Abfrage ist ein Merkliste-Objekt. Die gemerkten
	 ...
	 * gemerkte Nutzerprofil wird in eine Zeile der Tabelle eingefuegt. Zudem
	 * wird der Tabelle bei jedem Schleifendurchlauf je ein Button zum Loeschen
	 * und ein Button zum Anzeigen eines Vermerks hinzugefuegt.
	 */
				...
				new AsyncCallback<Merkliste>() {
					...
					public void onSuccess(Merkliste result) {
						...
						for (Nutzerprofil n : gemerkteNutzerprofile) {
							 ...
							 * betaetigt wird, wird geprueft, ob das
							 * Nutzerprofil von diesem Fremdprofil gesperrt
							 * wurde. Wenn ja, wird eine entsprechende
							 * Information ausgegeben, die ueber diesen Zustand
							 * informiert. Wenn nein, wird die Seite zum
							 * Anzeigen eines Fremdprofils aufgerufen.
							 */
