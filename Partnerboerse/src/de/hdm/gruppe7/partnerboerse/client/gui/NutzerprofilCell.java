...
/**
 * Klasse zur Darstellung von Nutzerprofil-Objekten. Solche Erweiterungen von
 * <code>AbstractCell<T></code> dienen zur Erzeugung von HTML-Code für
 * benutzerdefinierte Objekte.
 * 
 * In diesem Fall wird die <code>id</code> eines Kontoobjekts mit einem
 * vorangestellten "Kontonnr. " in einem <code>div-</code>Element erzeugt.
 *
 */

public class NutzerprofilCell extends AbstractCell<Nutzerprofil> {

	public void render(com.google.gwt.cell.client.Cell.Context context, Nutzerprofil value, SafeHtmlBuilder sb) {
