		...
		anzeigenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				ClientsideSettings.getPartnerboerseAdministration()
						.getSuchprofilByName(nutzerprofil, auswahlListBox.getSelectedItemText(), new AsyncCallback<Suchprofil>() {
				...
				loeschenButton.addClickHandler(new ClickHandler() {
					public void onClick(ClickEvent event) {
						...
						// Suchprofil loeschen.
						ClientsideSettings.getPartnerboerseAdministration()
								.deleteSuchprofil(nutzerprofil, auswahlListBox.getSelectedItemText(), new AsyncCallback<Void>() {
