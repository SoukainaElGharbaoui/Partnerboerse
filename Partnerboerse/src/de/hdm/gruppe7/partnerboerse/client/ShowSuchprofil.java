...
public class ShowSuchprofil extends VerticalPanel {
	 ...
	 * 
	 * @param suchprofilId
	 *            Die Profil-ID des Suchprofils, das angezeigt werden soll.
	 * @param profiltyp
	...
	public void run() {
		 ...
		 */
		showSuchprofilFlexTable.setText(0, 0, "Suchprofilname");
		 ...
		 * Sobald dieser Button betaetigt wird, wird die Seite zum Anlegen eines
		...
		bearbeitenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				EditSuchprofil editSuchprofil = new EditSuchprofil(showSuchprofilFlexTable.getText(0, 1), profiltyp);
				RootPanel.get("Details").clear();
	...
	/**
	 * Methode erstellen, die alle Suchprofile des Nutzerprofils ausliest und
	 * die ListBox mit den Suchprofilnamen befuellt. Existieren zu diesem
	 * Nutzerprofil bisher keine Suchprofile, werden die gewoehnlichen Inhalte
	 * der Seite ausgeblendet und es wird eine Information ausgegeben, die ueber
	 * diesen Zustand informiert. Zudem wird ein Button eingeblendet, durch den
	 * neue Suchprofile angelegt werden koennen.
	 */
	...
	/**
	 * Methode erstellen, die ein Suchprofil anhand der Profil-ID ausliest und
	 * die Tabelle mit den Suchprofildaten befuellt.
	 */
	public void getSuchprofil() {
		ClientsideSettings.getPartnerboerseAdministration().getSuchprofilById(suchprofilId,
				new AsyncCallback<Suchprofil>() {
					...
					public void onSuccess(Suchprofil result) {
						...
						showSuchprofilFlexTable.setText(0, 1, result.getSuchprofilName());
						showSuchprofilFlexTable.setText(1, 1, result.getGeschlecht());
						showSuchprofilFlexTable.setText(2, 1, Integer.toString(result.getAlterMinInt()));
						showSuchprofilFlexTable.setText(3, 1, Integer.toString(result.getAlterMaxInt()));
						showSuchprofilFlexTable.setText(4, 1, Integer.toString(result.getKoerpergroesseInt()));
						showSuchprofilFlexTable.setText(5, 1, result.getHaarfarbe());
						showSuchprofilFlexTable.setText(6, 1, result.getRaucher());
						showSuchprofilFlexTable.setText(7, 1, result.getReligion());
	...
	/**
	 * Methode erstellen, die ein Suchprofil anhand der Profil-ID und anhand des
	 * Suchprofilnamens ausliest und die Tabelle mit den Suchprofildaten
	 * befuellt.
	 */
	...
	/**
	 * Methode erstellen, die ein Suchprofil loescht. Anschliessend wird die
	 * Seite zum Anzeigen der Suchprofile aufgerufen. Hier wird, falls
	 * verfuegbar, das naechste Suchprofil des Nutzerprofils angezeigt.
	 */
	public void deleteSuchprofil() {
		if (Window.confirm("Möchten Sie dieses Suchprofil wirklich löschen?")) {
			...
			ClientsideSettings.getPartnerboerseAdministration().deleteSuchprofil(nutzerprofil.getProfilId(),
					showSuchprofilFlexTable.getText(0, 1), new AsyncCallback<Void>() {
