...
public class EditSuchprofil extends VerticalPanel {
	...
	public EditSuchprofil() {
		...
		/**
		 * Tabelle erzeugen, in der das Suchprofil dargestellt wird und
		...
		/**
		 * Drittte Spalte der Tabelle festlegen (Textboxen zum bearbeiten der
		 * Werte)
		 */
		...
		speichernButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				ClientsideSettings.getPartnerboerseAdministration().save(
