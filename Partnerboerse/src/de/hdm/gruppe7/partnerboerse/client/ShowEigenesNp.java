				...
				.getNutzerprofilById(Benutzer.getProfilId(),
						new AsyncCallback<Nutzerprofil>() {
							...
							public void onSuccess(Nutzerprofil result) {
								...
								final Button bearbeitenButton = new Button(
										"Bearbeiten");
								// verPanel.add(buttonPanel);
								showEigenesNpFlexTable.setWidget(9, 2,
										bearbeitenButton);

								// Löschen-Button hinzufügen und ausbauen.

								final Button loeschenButton = new Button(
										"Löschen");
								// verPanel.add(buttonPanel);
								showEigenesNpFlexTable.setWidget(9, 1,
										loeschenButton);
