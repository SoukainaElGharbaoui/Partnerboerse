 ...
 * @author Thies
 *  * ------------------------------------------------------------------------------------------
 * Diese Klasse wurde, wie von Herrn Prof. Dr. Thies in der Vorlesung gewÃ¼nscht, als Grundlage 
 * Ã¼bernommen und bei Notwendigkeit an die BedÃ¼rfnisse des IT-Projekts SS 2016 "Partnerboerse" 
 * angepasst. 
 * 
...
public class HTMLReportWriter extends ReportWriter {
	...
	public String getTrailer() {
	   ...
	   */
	public void process(AllSuchprofileOfNutzerReport r) {
