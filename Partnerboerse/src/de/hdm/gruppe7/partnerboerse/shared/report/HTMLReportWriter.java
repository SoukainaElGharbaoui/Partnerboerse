 ...
 *         Thies in der Vorlesung gewÃ¼nscht, als Grundlage Ã¼bernommen und bei
 *         Notwendigkeit an die BedÃ¼rfnisse des IT-Projekts SS 2016
...
public class HTMLReportWriter extends ReportWriter {
	...
	public void process(AllInfosOfNutzerReport r) {
		 ...
		 * der reportText-Variable zugewiesen. Dadurch wird es mÃ¶glich,
		 * anschlieÃŸend das Ergebnis mittels getReportText() auszulesen.
		 */
