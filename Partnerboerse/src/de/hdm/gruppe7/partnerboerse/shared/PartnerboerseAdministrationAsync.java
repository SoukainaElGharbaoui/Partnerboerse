...
public interface PartnerboerseAdministrationAsync {
	 ...
	 * Suchprofil anlegen.
	 */
	void createSuchprofil(Nutzerprofil nutzerprofil, String suchprofilName, String geschlecht, int alterMinInt,
	 ...
	 */
	void saveSuchprofil(Nutzerprofil nutzerprofil, int profilId, String suchprofilName, String geschlecht,
	 ...
	 * Suchprofil loeschen.
	 */
	void deleteSuchprofil(Nutzerprofil nutzerprofil, String suchprofilName, AsyncCallback<Void> callback);

	/**
	 * Alle Suchprofile eines Nutzers anzeigen.
	 */
	void getAllSuchprofileFor(Nutzerprofil nutzerprofil, AsyncCallback<List<Suchprofil>> callback);

	/**
	 * Suchprofil anhand des Suchprofilnamens auslesen.
	 */
	void getSuchprofilByName(Nutzerprofil nutzerprofil, String suchprofilName, AsyncCallback<Suchprofil> callback);

	/**
	 * Suchprofilname beim Anlegen eines Suchprofils ueberpruefen.
	 */
	void pruefeSuchprofilnameCreate(Nutzerprofil nutzerprofil, String suchprofilname, AsyncCallback<Integer> callback);

	/**
	 * Suchprofilname beim Editieren eines Suchprofils ueberpruefen.
	 */
	void pruefeSuchprofilnameEdit(Nutzerprofil nutzerprofil, int suchprofilId, String suchprofilname,
	...
	void getGemerkteNutzerprofileFor(Nutzerprofil nutzerprofil, AsyncCallback<Merkliste> callback);
	...
	void getGesperrteNutzerprofileFor(Nutzerprofil nutzerprofil, AsyncCallback<Sperrliste> callback);
	...
	void getUnangeseheneNutzerprofile(Nutzerprofil nutzerprofil, AsyncCallback<List<Nutzerprofil>> callback);
	...
	void aehnlichkeitEntfernen(Nutzerprofil nutzerprofil, AsyncCallback<Void> callback);

	void getGeordnetePartnervorschlaegeNp(Nutzerprofil nutzerprofil, AsyncCallback<List<Nutzerprofil>> callback);
	...
	void berechneAehnlichkeitSpFor(Nutzerprofil nutzerprofil, AsyncCallback<Void> callback);

	void aehnlichkeitEntfernenSp(Nutzerprofil nutzerprofil, AsyncCallback<Void> callback);

	void getGeordnetePartnervorschlaegeSp(Nutzerprofil nutzerprofil, String suchprofilName,
	...
	// void createInfoNeuSp(int suchprofilId, int eigenschaftId, String
	...
	void getEigenschaftstextById(int eigenschaftId, AsyncCallback<String> callback);
